          ...
          <div className="flex-1 space-y-4 text-center md:text-left">
            ...
            <div className="flex justify-center md:justify-start gap-6 mt-4">
              <div className="text-center">
                ...
                <span className="text-xs text-gray-400 font-mono">Posts</span>
              </div>
              <div className="text-center">
                <span className="block text-xl font-bold text-gray-900">
                  {user.followers}
            ...
            <div className="flex justify-center md:justify-start gap-4 mt-6">
              <button className="flex items-center gap-2 bg-indigo-600 hover:bg-indigo-500 text-white px-4 py-2 rounded-xl font-semibold transition-all duration-200">
